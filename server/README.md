...
| `GET /api/unsubscribe?token=` | One-click unsubscribe from email footers, idempotent |
...
1. Apply `supabase/migrations/add_circular_subscribers.sql` in the Supabase SQL
